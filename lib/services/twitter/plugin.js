		...
		return callback(null, {
			fetchContacts: function(passportSession, service, options, done) {
		    	...
		    	return ensureUserInfo(function(err) {
		    		...
		    		console.log("[rolodex][twitter] Fetch contacts for: " + passportSession.username);
		    		...
		    		function fetchIDs(cursor, callback) {
			    		...
			    		return requester(function(callback) {
			    			...
			    			if (initOptions.debug) console.log("[rolodex][twitter] fetch:", url);
							...
							return REQUEST.get({
								...
								*/
								try {
									...
									console.error("[rolodex][twitter] data:", data);
									return callback(err);
								}
			    		...
			    		return requester(function(callback) {
							...
							return REQUEST.get({
								...
								try {
									...
									console.error("[rolodex][twitter] users:", users);
									return callback(err);
								}
