		...
		return callback(null, {
			...
			fetchContacts: function(passportSession, service, options, done) {
		    	...
		    	return ensureUserInfo(function(err) {
		    		...
		    		console.log("[rolodex][facebook] Fetch contacts for: " + passportSession.displayName);
		    		...
		    		function fetchPage(url, callback) {
						return REQUEST.get({
							...
							try {
								...
								console.error("[rolodex][facebook] users:", users);
								return callback(err);
							}
		    		...
		    		return fetchPage(null, function(err) {
						...
						if (service.contactsFetched !== service.contactsTotal) {
							console.warn("[rolodex][facebook] ERROR: `contactsFetched` (" + service.contactsFetched + ") != `contactsTotal` (" + service.contactsTotal + ")");
						}
