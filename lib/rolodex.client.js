...
define([
	"eventemitter2",	// https://github.com/hij1nx/EventEmitter2/blob/44adb42a147cfda62ff74f68b6cc8313cc2dfeb4/lib/eventemitter2.js
	"q"					// https://github.com/kriskowal/q/blob/5cbbfe8138bf4108a7e543058a3be2b925e8e283/q.js
], function(EVENTS, Q) {
	...
	Rolodex.prototype.getServices = function(forceFetch) {
		...
		JQUERY.ajax({
			method: "GET",
			dataType: "json",
			url: self._baseURL + self._routes.services,
			xhrFields: {
	...
	Rolodex.prototype.getContacts = function(serviceId, forceFetch) {
		...
		function fetch(serviceId) {
			...
			JQUERY.ajax({
				method: "GET",
				dataType: "json",
				url: self._baseURL + self._routes.contacts + ((!serviceId || serviceId==="*")?"":"/"+serviceId),
				xhrFields: {
	                withCredentials: true
	            },
	            crossDomain: true
